...
class TestBestMove(unittest.TestCase):
    ...
    def test_bext_move(self):
        ...
        game = Game(statetemp.hexboard, players, 0, 2)
        game_tree = game.game_tree(statetemp)
        self.assertEqual(PlayerInterface.best_move(interface, game_tree, player1, 2), (1, 10))
    ...
    def test_bext_move2(self):
        ...
        game = Game(statetemp.hexboard, players, 0, 2)
        game_tree = game.game_tree(statetemp)
        self.assertEqual(PlayerInterface.best_move(interface, game_tree, player1, 2), (9,10))
    ...
    def test_best_move3(self):
        ...
        game = Game(statetemp.hexboard, players, 0, 2)
        game_tree = game.game_tree(statetemp)
        self.assertEqual(PlayerInterface.best_move(interface, game_tree, player1, 2), (3, 12))
...
class TestBestPath(unittest.TestCase):
    ...
    def test_next_path(self):
        ...
        game = Game(statetemp.hexboard, players, 0, 2)
        game_tree = game.game_tree(statetemp)
        # self.assertEqual(interface.best_path(game_tree, player1, 2)[3][0], 3)
...
class TestScoreList(unittest.TestCase):
    ...
    def test_score_list(self):
        ...
        # self.assertEqual(len(interface.check_scores(best_path, player1)), 15)
    ...
    def test_score_list1(self):
        ...
        all_paths, origin_list = interface.get_all_paths(game_tree)
        best_path = interface.check_best_path(origin_list, player1, game_tree)
        # self.assertEqual(len(interface.check_scores(best_path, player1)), 24)
...
class TestAllPaths(unittest.TestCase):
    ...
    def test_all_paths(self):
        ...
        game_tree = game.game_tree(statetemp)
        all_paths, origin_list = interface.get_all_paths(game_tree)
        self.assertEqual(len(all_paths), 4)
    ...
    def test_all_paths1(self):
        ...
        game_tree = game.game_tree(statetemp)
        all_paths, origin_list = interface.get_all_paths(game_tree)
        self.assertEqual(len(all_paths[1]), 2)
...
class TestOriginList(unittest.TestCase):
    ...
    def test_origin_list(self):
        ...
        game_tree = game.game_tree(statetemp)
        all_paths, origin_list = interface.get_all_paths(game_tree)
        self.assertEqual(len(origin_list), 1)
    ...
    def test_origin_list1(self):
        ...
        game_tree = game.game_tree(statetemp)
        all_paths, origin_list = interface.get_all_paths(game_tree)
        # self.assertEqual(len(origin_list[5][1]), 3)
...
class TestCheckBestPath(unittest.TestCase):
    ...
    def test_check_best_path(self):
        ...
        game_tree = game.game_tree(statetemp)
        all_paths, origin_list = interface.get_all_paths(game_tree)
        self.assertEqual(len(interface.check_best_path(origin_list, player1, game_tree)), 1)
...
class TestPlaceOrderedPenguin(unittest.TestCase):
    ...
    def test_place_ordered_penguin1(self):
        ...
        interface = PlayerInterface(statetemp, player1, players)
        game = Game(statetemp.hexboard, players, 0, 2)
        interface.place_ordered_penguins(statetemp, player1, 3)
        self.assertEqual(len(player1.penguins), 4)
    ...
    def test_place_ordered_penguin2(self):
        ...
        game = Game(statetemp.hexboard, players, 0, 2)
        interface.place_ordered_penguins(statetemp, player1, 3)
        interface.place_ordered_penguins(statetemp, player2, 3)
