...
class Game:
    ...
    def tree_findpenguins(self, starting_state, player):
        ...
        for a_player in starting_state.players:
            # print "player", player
            # print "checking players: ", self.players
            # print "Self players: ", self.players[player]
    ...
    def tree_states(self, starting_state, player):
        ...
        for penguin in penguins:
            ...
            for move in possible_moves:
                ...
                all_states.append((temporary_state2, (origin, destination)))
        return all_states
    ...
    # @return returned_items A list of states that have the function executed
    # Ex. <state.GameState instance at 0x0000000002B7D048>
    def game_tree(self, current_state):
        ...
        while layer_count < layers:
            for item in current_game_tree:
                ...
                if item[0] == layer_count:
                    ...
                    if predicted_state == []:
                        no_more_states = self.map_states(item[1], current_state.is_over(item[1]), self.player_index)
                        if no_more_states == []:
                    ...
                    for next_state in predicted_state:
                        # print 'next state score: ', next_state.players[0].score
                        current_game_tree.append((layer_count + 1, next_state[0], item_state_temp, next_state[1]))
...
if __name__ == "__main__":
    ...
    game = Game(statetemp.hexboard, players, 0, 3)
