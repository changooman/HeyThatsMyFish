from Other.state import *
from Other.board import RenderHexBoard
from Other.strategy import *
...
class Referee:
    ...
    # @param playercomp A PlayerComp object performs the actions of placing players, and moving penguins based on the
    # strategy.
    # Example: <state.PlayerComp instance at 0x0000000002B7D048>
    ...
    # @param style A string that represents the style that the penguins will be placed in at the start of a game.
    # Example: "Zigzag", "Random"
    # @param penguins A list of coordinates that represents the total number of penguins to be given to each
    # individual player.
    # Example: [[0,0], [1,0], [1,1]]
    # @return winners A a list of players that got the highest score or tied for the winning score.
    # Example: [<__main__.Player instance at 0x0000000003456348>], [<__main__.Player instance at 0x0000000004456048>,
    # <__main__.Player instance at 0x0000000003445648>]
    ...
    # @param player A Player object that represents the player that is going to be removed.
