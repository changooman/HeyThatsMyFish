...
class Testing_Neighbors(unittest.TestCase):
    def test_neighbor(self):
        ...
        self.assertEqual(len(hex_board.find_neighbors(hex_board.hexagons[0])), 2)


    def test_neighbor2(self):
        hex_board = HexBoard(30, 4, 3,  [])
        self.assertEqual(len(hex_board.find_neighbors(hex_board.hexagons[3])), 5)


    def test_neighbor3(self):
        hex_board = HexBoard(30, 4, 3,  [])
        self.assertEqual(len(hex_board.find_neighbors(hex_board.hexagons[9])), 3)


    def test_neighbor4(self):
        hex_board = HexBoard(30, 4, 3,  [])
        self.assertEqual(len(hex_board.find_neighbors(hex_board.hexagons[10])), 5)
...
class Test_ResetTiles(unittest.TestCase):
    def test_resetiles(self):
        hex_board = HexBoard(30, 4, 3, [])
        clicked = 1
        self.assertEqual(hex_board.reset_tiles(clicked).xy, hex_board.hexagons[int(clicked) - 1].xy)
